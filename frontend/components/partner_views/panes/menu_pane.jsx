    ...
    return (
      <div className='inner-grid menu-pane'>
        ...
        <div className='inner-grid-child menu-pane-body'>
          ...
          <section className='menu-section modifiers'>
            <ul>{menuModifiers}</ul>
          </section>
        </div>
      </div>
